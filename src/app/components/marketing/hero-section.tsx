...
type TabType = 'ats' | 'chat' | 'resume' | 'interview' | 'tracker'
...
export function HeroSection() {
  ...
  return (
    <section className="relative flex flex-col items-center overflow-x-clip px-4 sm:px-6 pt-[8vh] md:pt-[10vh] pb-0 w-full">
      ...
      {/* ── 1150px FULL REAL-SIZE BROWSER MOCKUP FRAME ── */}
      <div className="w-full flex justify-center mt-12 md:mt-16 z-10">
        <div className="relative w-full max-w-[1150px] mx-auto">
          ...
          {/* App Window Container — Spacious Full-Scale Real Proportions */}
          <div className="relative overflow-hidden rounded-t-2xl sm:rounded-t-3xl neuro-card border border-border/80 shadow-2xl translate-y-3 sm:translate-y-4 bg-background min-h-[580px] md:min-h-[640px] flex flex-col w-full">
            ...
            {/* Tab Content Area — 100% Real UI Replica */}
            <div className="p-5 sm:p-7 bg-background flex-1 flex flex-col justify-between overflow-hidden">
              
              {/* TAB 1: ATS OPTIMIZER (Matches src/app/components/ats/ats-view.tsx) */}
              {activeTab === 'ats' && (
              ...
              {/* TAB 2: AI CAREER COACH (Matches src/app/components/chat/chat-view.tsx) */}
              {activeTab === 'chat' && (
                <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-4 animate-fade-in h-full">
                  ...
                  <div className="flex flex-col justify-between rounded-xl neuro-card p-5 border border-border/60 bg-background space-y-4">
