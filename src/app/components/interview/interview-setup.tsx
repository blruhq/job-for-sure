          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                >
                      <SelectTrigger aria-label="Select target position" className="w-full neuro-inset rounded-sm px-3 py-2 text-xs">
              ...
              <div>
                ...
                {(applications?.bookmark?.length ?? 0) > 0 ? (
                  <div className="space-y-2">
                    ...
                    >
                  <SelectTrigger aria-label="Select resume for interview" className="w-full neuro-inset rounded-sm px-3 py-2 text-xs">
